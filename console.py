...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, line):
        ...
        Create new class instance given keys/values and print its id.
        """
        try:
            if not line:
                raise SyntaxError()
    ...
    def do_all(self, line):
        """Usage: our all <class> or <class>.all()
    ...
    def do_update(self, line):
        ...
        Exceptions:
            ...
            IndexError: there is no id given
            KeyError: there is no valid id given
            AttributeError: there is no attribute given
            ValueError: there is no value given
        """
        try:
            if not line:
                raise SyntaxError()
